...
import { getRouteColor, ROUTE_COLORS } from "@/lib/route-colors";
...
export function UserControl({
  ...
  const [users, setUsers] = usePersistentState<string[]>(
    "delivery.users",
    DEFAULT_USERS,
  );
  const [selectedUser, setSelectedUser] = usePersistentState<string>(
    "delivery.userId",
    "user_demo",
  );
